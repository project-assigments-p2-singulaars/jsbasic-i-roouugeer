...
console.log("Bienvenida/o al bootcamp P2 Juniors (BCN Singulars) de Factoria F5")
...
let cadenaDeTexto = "Hola y adios"
...
let comida = ["helado", "tarta", "pastel"];
...
let numerosSumar = 5+7;

console.log(numerosSumar)
...
let numerosRestar = 7-2;

console.log(numerosRestar)
...
let numerosDividir = 8/3;

console.log(numerosDividir)
...
let numeroUno = 1;
let numeroDos = 2;
let comparar = numeroDos < numeroDos;
...
let compararOtraVez = numeroDos + numeroUno < numeroTres;

console.log(compararOtraVez);
...
let result = num1 === num3AsString//Realiza la operación de comparación que consideres entre las dos variables dadas, para que el resultado en consola sea false sin usar el comparador de desigualdad
console.log(result) 
